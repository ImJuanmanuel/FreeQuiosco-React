    ...
    return (
        <div className=" md:flex gap-10">
            ...
            <div className=" md:w-2/3">
                ...
                <h1 className=" text-3xl font-bold font-serif mt-5">
                    {producto.nombre}
                </h1>
                <p className="mt-5 font-black font-sans text-5xl text-amber-500">
                ...
                <button
                    type="button"
                    className=" bg-indigo-600 hover:bg-indigo-900 text-white mt-7 px-5 py-2 font-bold uppercase rounded
